...
const SHORTCUTS = [
  ...
  { keys: ['R'], description: 'Replay sentence (RSVP mode)' },
  { keys: ['+', '='], description: 'Increase chunk size (RSVP mode)' },
  { keys: ['-'], description: 'Decrease chunk size (RSVP mode)' },
  ...
  { keys: ['Ctrl', 'D'], description: 'Add quick bookmark' },
